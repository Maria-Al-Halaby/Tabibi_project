...
@section('content')
    <section class="section-card empty-state" style="min-height: 70vh; display: flex; flex-direction: column; justify-content: center;">
        ...
        <span class="eyebrow mx-auto mb-3">
            ...
            {{ __('Error 404') }}</span>
        <h1 class="page-title mb-3">{{ __('This super-admin page could not be found.') }}</h1>
        <p class="empty-state__copy">
            {{ __('The route may be incorrect, the page may have moved, or the requested screen is not available anymore.') }}</p>
