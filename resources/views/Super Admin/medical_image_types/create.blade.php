...
@section('title', __('Add Medical Image Type'))
    ...
    <div class="page-header">
        <div>
            <span class="eyebrow">
                ...
                {{ __('New Medical Image Type') }}</span>
            <h1 class="page-title">{{ __('Add a radiology image type with a clear Super Admin flow.') }}</h1>
            <p class="page-subtitle">
                {{ __('Create a reusable medical image type that clinics can later price and expose in radiology workflows.') }}</p>
        </div>
    </div>
