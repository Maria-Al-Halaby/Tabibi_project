    ...
    <div class="page-header">
        <div>
            <span class="eyebrow">
                ...
                {{ __('New Lab Test') }}</span>
            <h1 class="page-title">{{ __('Add a lab test with the same clean Super Admin workflow.') }}</h1>
            <p class="page-subtitle">
                {{ __('Create a new lab test once, then make it available across the platform wherever it is needed.') }}</p>
        </div>
    </div>
