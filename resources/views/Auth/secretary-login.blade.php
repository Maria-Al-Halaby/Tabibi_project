...
<head>
    ...
    <title>{{ __('Tabiby Secretary Login') }}</title>
    ...
    <main class="login-shell">
        <div class="login-frame">
            <section class="login-showcase">
                ...
                <h1 class="showcase-title">{{ __('Access your appointment desk dashboard.') }}</h1>
                <p class="showcase-copy">
                    {{ __('Sign in to review pending appointments, filter bookings by specialty, and support the center’s
                    front-desk workflow.') }}</p>

                <div class="showcase-grid">
                    <div class="showcase-card">
                        <div class="showcase-card__label">{{ __('Appointment Desk') }}</div>
                        <p class="showcase-card__value">{{ __('Review and organize pending appointments for your center.') }}</p>
                    </div>

                    <div class="showcase-card">
                        <div class="showcase-card__label">{{ __('Specialty Filters') }}</div>
                        <p class="showcase-card__value">{{ __('Narrow the queue by specialty to act faster during busy hours.') }}</p>
                    </div>
                </div>
            </section>
            ...
            <section class="login-panel">
                ...
                <div class="login-panel__header">
                    <span class="login-panel__eyebrow">
                        ...
                        {{ __('Secretary Login') }}</span>
                    <h2 class="login-panel__title">{{ __('Welcome back') }}</h2>
                    <p class="login-panel__copy">{{ __('Use your email and password to access your dashboard.') }}</p>
                </div>
                ...
                @if ($errors->any())<div class="alert alert-danger shadow-sm mb-4" role="alert">
                ...
                <a href="{{ route('login') }}" class="back-link">
                    ...
                    {{ __('Back to staff login') }}</a>

                <p class="support-copy">{{ __('If you cannot access your account, contact your center administrator.') }}</p>
            </section>
        </div>
    </main>
