...
use App\Http\Controllers\SuperAdmin\AiLimitController;
...
Route::middleware(['auth', 'role:super admin'])->prefix('/SuperAdmin/Dashborad/')->group(function () {
    ...
    /* AI limits route */
    Route::get('/ai-limits', [AiLimitController::class, 'index'])->name('SuperAdmin.AiLimits.index');
    Route::put('/ai-limits/{featureType}', [AiLimitController::class, 'updateLimit'])->name('SuperAdmin.AiLimits.updateLimit');
    Route::put('/ai-usages/{usage}', [AiLimitController::class, 'updateUsage'])->name('SuperAdmin.AiLimits.updateUsage');
